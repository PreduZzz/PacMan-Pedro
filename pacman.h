/*
 * ============================================================
 *  PAC-MAN HOGWARTS — Projeto MVC em C  [VERSAO APRIMORADA]
 * ============================================================
...
#define INF         999999
#define MAP_COUNT   5
#define SCORE_FILE  "hogwarts_scores.dat"
...
#define CLR_WALL        "\033[38;5;178;1m"
...
#define CLR_PACMAN      "\033[38;5;196;1m"
#define CLR_PACMAN_SHADOW "\033[38;5;220m"
#define CLR_BLINKY      "\033[38;5;34;1m"
#define CLR_PINKY       "\033[38;5;93;1m"
#define CLR_INKY        "\033[38;5;27;1m"
#define CLR_CLYDE       "\033[38;5;220;1m"
...
typedef struct {
    ...
    char player_name[16];
    int debug_mode;
    int dijkstra_path_on;
    int avl_rot_single;
    int avl_rot_double;
    int bst_last_search;
    char best_sort_name[16];
    long long best_sort_time;
...
int      avl_rotation_single_count(void);
int      avl_rotation_double_count(void);
